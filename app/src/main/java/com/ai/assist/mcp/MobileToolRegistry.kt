...
object MobileToolRegistry {
    val descriptions: String = """
        ...
        - scheduleLaunch(appQuery?: string, toolName?: string, delayMinutes: string, arg_title?: string, arg_to?: string, arg_subject?: string, arg_body?: string): approval required, add an app-owned Plan for launch or another tool.
